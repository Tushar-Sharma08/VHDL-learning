...
REM
REM Generated by Vivado on Thu Jun 18 21:33:17 +0530 2026
...
echo "xvhdl --incr --relax -prj J_Cou_wrapper_vhdl.prj"
call xvhdl  --incr --relax -prj J_Cou_wrapper_vhdl.prj -log xvhdl.log
