...
#
# Script generated by Vivado on Thu Jun 18 21:33:14 +0530 2026
...
#
# Usage        : J_Cou.sh
#                J_Cou.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                J_Cou.sh [-reset_run]
#                J_Cou.sh [-reset_log]
#                J_Cou.sh [-help]
#
...
# script info
echo -e "J_Cou.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./J_Cou.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot J_Cou xil_defaultlib.J_Cou -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim J_Cou -key {Behavioral:sim_1:Functional:J_Cou} -tclbatch cmd.tcl -protoinst "protoinst_files/J_Cou.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb J_Cou.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./J_Cou.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: J_Cou.sh [-help]\n\
Usage: J_Cou.sh [-step]\n\
Usage: J_Cou.sh [-lib_map_path]\n\
Usage: J_Cou.sh [-reset_run]\n\
Usage: J_Cou.sh [-reset_log]\n\
Usage: J_Cou.sh [-keep_index]\n\
Usage: J_Cou.sh [-noclean_files]\n\n\
